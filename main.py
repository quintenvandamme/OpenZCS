...
def help():
   ...
   Button(master=help, borderwidth=0, bg='black', fg='white', text="OK", relief="flat", width=7, height=1, command=lambda:help_exit(help), font=('Segoe UI Semibold', 10)).place(x=383, y=517)
   helpN = Button(master=help, borderwidth=0, bg='black', fg='white', text="Next", relief="flat", width=7, height=1, command=lambda:help_next(), font=('Segoe UI Semibold', 10))
   helpN.place(x=300, y=517)
   helpB = Button(master=help, borderwidth=0, bg='grey', fg='white', text="Back", relief="flat", width=7, height=1, command=lambda:help_back(), font=('Segoe UI Semibold', 10))
   helpB.place(x=225, y=517)
   help_view = Text(help, height = 28, width = 60, relief="flat",font =('Segoe UI', 10), bg = "white")
...
Button(master=window, text="New", relief="flat",borderwidth=0, width=5, height=1, font=('Segoe UI Semibold', 11), bg="white", command = lambda:new()).place(x=5, y=0)
Button(master=window, text="Save", relief="flat",borderwidth=0, width=5, height=1, font=('Segoe UI Semibold', 11), bg="white").place(x=60, y=0)
Button(master=window, text="Run", relief="flat",borderwidth=0, width=5, height=1, font=('Segoe UI Semibold', 11), bg="white", command = lambda:run()).place(x=115, y=0)
Button(master=window, text="Help", relief="flat",borderwidth=0, width=5, height=1, font=('Segoe UI Semibold', 11), bg="white", command = lambda:help()).place(x=170, y=0)
Button(master=window, text="Info", relief="flat",borderwidth=0, width=5, height=1, font=('Segoe UI Semibold', 11), bg="white", command = lambda:about()).place(x=225, y=0)
